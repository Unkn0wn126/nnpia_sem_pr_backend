...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList(frontendUrl, frontendUrl + "/**"));
        ...
        http.authorizeRequests(authorizeRequests ->
            authorizeRequests
                    ...
                    .antMatchers("/api/v1/admin/users/**").hasAnyAuthority("ROLE_ADMIN")
                    .antMatchers("/api/v1/admin/issues/**").hasAnyAuthority("ROLE_ADMIN")
                    .antMatchers("/api/v1/admin/comments/**").hasAnyAuthority("ROLE_ADMIN")
